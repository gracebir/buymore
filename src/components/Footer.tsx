...
function Footer() {
  return (
    <footer className="w-full py-6 border-t border-dark-color">
      <div className="flex max-w-6xl mx-auto lg:justify-between lg:flex-row flex-col items-center">
      <p className='text-gray-400 font-semibold'>Copyright &copy; 2023. All Rights Reserved. Developed by <a className="hover:text-gray-200 duration-300" href="https://github.com/gracebir">Grace</a></p>
