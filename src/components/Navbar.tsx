        ...
        <header className='w-full flex flex-col'>
            <div className='w-full border-b border-dark-color fixed lg:sticky z-50 py-6 bg-very-dark'>
                <div className="flex flex-row justify-between max-w-6xl mx-auto px-4 lg:px-0">
                    <div className="flex lg:hidden bg-blue-color w-10 h-10 items-center justify-center rounded-full cursor-pointer">
                        <BiMenuAltLeft size={25}/>
                    </div>
                    {/* logo */}
                    <div className='flex gap-8 items-center'>
                        <div className="text-blue-color flex flex-col gap-1 items-center cursor-pointer">
                            <p className='font-bold text-2xl'>bymore</p>
                            <div className='w-[45px] h-[4px] bg-blue-color'></div>
                        </div>
                        <div className='border hidden border-gray-500 lg:flex w-[450px] rounded-md'>
                            <input className="w-full px-3 py-2 outline-none bg-very-dark rounded-tl-md rounded-bl-md" type="text" placeholder="What are you looking for?" />
                            <div className='w-12 cursor-pointer flex items-center justify-center bg-blue-color rounded-tr-md rounded-br-md'>
                                <CiSearch size={20}/>
                            </div>
                        </div>
                    </div>
